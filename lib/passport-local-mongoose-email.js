...
module.exports = function(schema, options) {
    ...
    schemaFields[options.token] = String;
    ...
    schema.methods.setToken = function (cb) {        
        var self = this;
    ...
    schema.statics.register = function(user, password, cb) {
        ...
        self.findByUsername(user.get(options.usernameField), function(err, existingUser) {
            ...
            user.setPassword(password, function(err, user) {
                ...
                user.setToken(function(err,user) {
    ...
    schema.statics.verifyEmail = function(token, cb) {
        var self = this;
    ...
    schema.statics.findByToken = function(token, cb) {
        ...
        queryParameters[options.token] = token;
